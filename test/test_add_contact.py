...
def test_add_contact(app):
    ...
    app.fill_contact_form(Contact(firstname="Иван", middlename="Иванов", lastname="Иванович", nickname="Ivanov_Ivan", title="q", company="w", address="e", home="555-55-55",
...
def test_add_empty_contact(app):
    ...
    app.login(username="admin", password="secret")
    app.open_contacts_page()
    app.fill_contact_form(Contact(firstname="", middlename="", lastname="", nickname="", title="", company="", address="", home="",
